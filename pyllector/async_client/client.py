...
class ApiCollectorAsync(aiohttp.ClientSession):
    ...
    @staticmethod
    async def _return_content_by_content_type(content_type: ContentType, response: aiohttp.ClientResponse) -> str | dict:
    ...
    @staticmethod
    def _right_main_link(main_link):

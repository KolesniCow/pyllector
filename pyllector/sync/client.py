...
class ApiClient(Session):
    ...
    @staticmethod
    def _return_content_by_content_type(content_type: ContentType, response: Response) -> str | dict | None:
    ...
    def push(self, method: str = '', content_type: ContentType = ContentType.TEXT,
        ...
        with self.request(http_method.value, f'{self.main_api_link}{method}', params=params, **kwargs) as response:
